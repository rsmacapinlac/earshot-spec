...
it shares the Earshot name and philosophy (local-only capture and local-first
operation) but is a distinct implementation with its own hardware, software stack,
and docs.
