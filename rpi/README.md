...
This documentation set is **v1.1** (see [CHANGELOG.md](CHANGELOG.md) and
`../AGENTS.md`). 
...
5. **Transcribe** on demand (LED **amber**) — on the Pi itself, needing no service, key, or internet. Optionally point it at an [earshot processing service](reference/processing-service.md) on your LAN to make that far faster and to add **diarization**, the one thing the Pi can't do alone.
...
[processing service](reference/processing-service.md), specified separately. Local transcription is
