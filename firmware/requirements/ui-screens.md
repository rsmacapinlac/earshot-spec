...
The canonical screen designs for earshot live in **Claude Design**, not in this
...
- The on-device prototype `earshot/src/app/screens.cpp` renders these screens
...
> A boot/splash screen is deferred until a earshot-branded asset exists.
