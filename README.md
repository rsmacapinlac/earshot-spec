...
| [`rpi/`](rpi/README.md) | device | Desk **conversation recorder** with a LAN web UI | Raspberry Pi 4B + Seeed ReSpeaker 2-Mic HAT | v1.3.3 | [rsmacapinlac/earshot](https://github.com/rsmacapinlac/earshot) |
